class Api::V1::EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:is_free_event, :is_tax_by_creator, :video_url, :latitude, :longitude, :address, :dress_code, :speaker, :start_date, :end_date, :title, :description, :status, :is_paid, :price, :owner_id, :cover_image, :has_published, :is_recurring, :recurring_type, :is_enabled, :max_tickets, ticket_packages_attributes: [:ticket_type, :price, :maximum_tickets])
  end
